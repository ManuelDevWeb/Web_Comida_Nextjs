  ...
  return (
    <div className="shadow p-5 mb-3 flex items-center gap-10">
      ...
      <div className="lg:w-1/6">
        <button
          type="button"
          className="bg-sky-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full lg:w-2/3"
          onClick={() => handleEditarCantidades(producto.id)}
        >
          {/* Icono Pencil, traido de heroicons */}
          <svg
        ...
        <button
          type="button"
          className="bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full lg:w-2/3 mt-3"
          onClick={() => handleEliminarProducto(producto.id)}
        >
          {/* Icono Trash, traido de heroicons */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            fill="none"
